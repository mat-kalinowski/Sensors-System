...
static const char *TAG = "ESP 8266 Node";
...
static esp_err_t mqtt_event_handler(esp_mqtt_event_handle_t event)
{
    ...
    switch(event->event_id){
        case MQTT_EVENT_CONNECTED:
            ...
            msg_id = esp_mqtt_client_subscribe(client, "nodes/discover", 0);
            printf("publishing discover response !!");
            msg_id = esp_mqtt_client_publish(client, "nodes/discover/response", TAG, 0, 1, 0);
            break;
...
void mqtt_setup()
{
    ...
    const esp_mqtt_client_config_t mqtt_cfg = {
        .uri = "mqtt://user:user@192.168.1.161:1883",
...
void app_main()
{
    ...
    printf("MAC ADDRESS OF THE BOARD: %s \n", mac_addr);
